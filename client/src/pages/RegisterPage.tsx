...
export function RegisterPage() {
  ...
  return (
    <div className="flex min-h-[calc(100svh-64px)] w-full flex-col items-center justify-center gap-8 px-6 py-10 lg:px-16 md:flex-row md:gap-16">
      {/* ── Left hero panel ── */}
      <div className="flex flex-1 flex-col gap-6 md:max-w-md">
        ...
        <div className="flex flex-col gap-3">
          <h1 className="text-4xl font-extrabold leading-tight tracking-tight text-foreground">
            Travel smarter, <span className="text-primary">stress less.</span>
          </h1>
          ...
          {PERKS.map((perk) => (
            <div key={perk} className="flex items-center gap-2.5">
              <div className="flex size-5 shrink-0 items-center justify-center rounded-full bg-primary">
                <Star className="size-2.5 text-primary-foreground fill-primary-foreground" />
              </div>
