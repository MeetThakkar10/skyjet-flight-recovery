...
export function StaffDashboardPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100svh-56px)] max-w-5xl flex-col gap-6 px-4 py-10">
      {/* ── Page hero banner ── */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 to-blue-900 p-6 text-white shadow-lg dark:from-slate-950 dark:to-blue-950">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,oklch(0.6_0.2_268/15%)_0%,transparent_65%)]" />
        <div className="relative flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-white/70">Manage passengers, bookings, and support tickets</p>
          </div>
        </div>
      </div>
              ...
              chatMessages.map((m) => (
                <div
                  ...
                  className={cn(
                    ...
                    m.sender === "passenger"
                      ? "ml-auto bg-gradient-to-br from-blue-700 to-blue-900 text-white"
