...
export function RebookingPage() {
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100svh-56px)] max-w-2xl flex-col justify-center gap-5 px-4 py-10">
      {/* ── Success celebration banner ── */}
      {confirmed ? (
        <div className="flex flex-col items-center gap-4 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 p-8 text-white shadow-xl text-center">
          ...
          <Button
            asChild
            className="bg-white text-emerald-700 font-semibold hover:bg-white/90 transition-colors shadow-md"
          >
        ...
        <Card className="border-border/60 shadow-xl">
          <CardHeader className="pb-4">
            <div className="mb-1 flex size-9 items-center justify-center rounded-xl bg-gradient-to-br from-blue-700 to-blue-900">
            ...
            {!isRecoveryFlow && canAutoRebook === false ? (
              <div className="flex flex-col gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
                ...
                <Button
                  ...
                  disabled={escalating}
                  className="bg-gradient-to-r from-blue-700 to-blue-900 text-white hover:opacity-90"
                >
